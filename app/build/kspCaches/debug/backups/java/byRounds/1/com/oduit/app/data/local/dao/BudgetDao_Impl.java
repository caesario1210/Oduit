...
public final class BudgetDao_Impl implements BudgetDao {
  ...
  public BudgetDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBudget = new EntityInsertionAdapter<Budget>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `budgets` (`id`,`categoryId`,`month`,`year`,`limitAmount`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindDouble(5, entity.getLimitAmount());
      }
    };
    ...
    this.__updateAdapterOfBudget = new EntityDeletionOrUpdateAdapter<Budget>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `budgets` SET `id` = ?,`categoryId` = ?,`month` = ?,`year` = ?,`limitAmount` = ? WHERE `id` = ?";
      }
      ...
      public List<Budget> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Budget(_tmpId,_tmpCategoryId,_tmpMonth,_tmpYear,_tmpLimitAmount);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Budget call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final double _tmpLimitAmount;
            _tmpLimitAmount = _cursor.getDouble(_cursorIndexOfLimitAmount);
            _result = new Budget(_tmpId,_tmpCategoryId,_tmpMonth,_tmpYear,_tmpLimitAmount);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getBudgetByCategory(final long categoryId, final int month, final int year,

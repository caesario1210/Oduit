...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`type`,`icon`,`color`,`isDefault`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
  ...
  public Flow<List<Category>> getAllCategories() {
    final String _sql = "SELECT * FROM categories ORDER BY type ASC, name ASC";
  ...
  @Override
  public Flow<List<Category>> getCategoriesByType(final String type) {
